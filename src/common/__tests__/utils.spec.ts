...
import { getPaggingMetadata, wrapperMoment } from '../utils';
  ...
  describe('utils', () => {
    ...
    describe('getPaggingMetadata', () => {
      it('should return metadata pagging when totalData greater than page', () => {
        ...
        const limit = 2;
        const page = 1;
        const result = getPaggingMetadata(totalData, limit, page);
    ...
    describe('wrapperMoment', () => {
      it('should reuturn moment when moment valid', () => {
        const result = wrapperMoment(moment());

        expect(result).toBeDefined();
      });

      it('should return null when moment invalid', () => {
        const result = wrapperMoment(moment(null));
